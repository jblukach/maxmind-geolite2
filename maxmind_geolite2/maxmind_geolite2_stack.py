...
class MaxmindGeolite2Stack(Stack):
    ...
    ### LAMBDA LAYER ###
        ...
        geoip2 = _lambda.LayerVersion.from_layer_version_arn(
            self, 'geoip2',
            layer_version_arn = 'arn:aws:lambda:'+region+':'+extensions.string_value+':layer:geoip2:5'
        )
        ...
        maxminddb = _lambda.LayerVersion.from_layer_version_arn(
            self, 'maxminddb',
            layer_version_arn = 'arn:aws:lambda:'+region+':'+extensions.string_value+':layer:maxminddb:7'
        )
    ...
    ### HOSTZONE ###
        ...
        cdnlogs = _logs.LogGroup(
            self, 'cdnlogs',
            log_group_name = '/aws/cloudfront/geotundralabsnet',
            retention = _logs.RetentionDays.THIRTEEN_MONTHS,
            removal_policy = RemovalPolicy.DESTROY
        )
